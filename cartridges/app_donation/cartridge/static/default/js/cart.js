...
var baseProduct = __webpack_require__(1);
...
$(document).on('click', 'button.cart-delete-confirmation-btn', function () {
    showDonationWidget();
});

$(document).on('click', '.quantity-form select.quantity.custom-select > option', function () {
    location.reload();
});
